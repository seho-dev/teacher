...
var wyUtil=function () {
    ...
    */
    ...
    return{
        ...
        //JQuery渐变弹出层（@唯译封装）WYAlert(id标签名字,弹出层存在时间,弹出层内容,背景颜色,文字颜色,弹出层宽,弹出层高)
             foAlert:function(name,time,content,bgColor,fontColor,width,height){
            ...
            //JQuery抖动弹出层（@唯译封装）ShakeAlert(id标签名字,弹出层存在时间,弹出层抖动速度,弹出层内容,背景颜色,文字颜色,弹出层宽,弹出层高)
            shakeAlert:function(name,time,sktime,content,bgColor,fontColor,width,height) {
                var alertH='<div class="empty" id='+name+' style="opacity:0;display:none;">'+content+'</div>';
                $('body').append(alertH);
                $('.empty').css({
                    background:""+bgColor+"",
            ...
            //JQuery提示弹出层（@唯译封装）promptAlert(id标签名字,弹出层内容,背景颜色,文字颜色,按钮内容,按钮背景颜色,按钮文字颜色,按钮hover背景颜色,按钮hover文字颜色,弹出层宽,弹出层高)
            promptAlert: function (name,content,bgColor,fontColor,inputContent,inputBgColor,inputFontColor,hoverAlertBgColor,hoverAlertFontColor,width,height) {
